...
## Network Analysis
n this graph, the size of Country Name is decided by the investment stock with China. The larger the stock is, the bigger the name is.
The color of the name varied by its largest CN FDI sector.
```{r net,warning=FALSE, message=FALSE}
library(dplyr)
library('igraph')
